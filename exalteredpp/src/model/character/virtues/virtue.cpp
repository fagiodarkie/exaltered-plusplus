...
namespace character {
  namespace virtues {
    ...
    virtue::virtue(enum virtue_enum virtue_e, unsigned int value, virtue_rank rank)
      : _virtue_enum(virtue_e), _rank(rank), _value(value)
    { }

    virtue_enum virtue::virtue_enum() const
    {
      return _virtue_enum;
    }
    ...
    {
      json[json_constants::SLOT_NAME] = VIRTUE_NAME.value(_virtue_enum);
