...
namespace ability
{
  ...
  public:
    ...
    ability_group(ability_enum ability_e = WAR,
                  std::vector<ability> abilities = { ability(ability_declination::NO_DECLINATION) },
                  std::vector<specialisation> specialisations = {});
    ability_group(const ability_group& o);
    ability_group& operator=(const ability_group& o);

    ability_enum get_ability_enum() const;
    std::string get_name() const;
    ability get_ability(const std::string& name = ability_declination::NO_DECLINATION) const;
    ...
    std::vector<detailed_ability> get_detailed_abilities() const;
    ...
    void set_favourite(bool is_favourite, const std::string& declination_name = ability_declination::NO_DECLINATION);
