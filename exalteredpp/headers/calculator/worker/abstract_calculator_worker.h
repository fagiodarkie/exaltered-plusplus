...
namespace calculator {
  namespace worker {
    ...
    public:
      ...
      virtual long int compute_persona                  (const character::creation::character_type& type, const character::attributes& attributes, const character::power::power_container& power) const = 0;
