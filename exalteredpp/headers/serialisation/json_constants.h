...
namespace serialisation
{
  struct json_constants
  {
    ...
    static const std::string SLOT_CRAFT_CATEGORY         ;
    static const std::string SLOT_CRAFT_SUBCATEGORY      ;
    static const std::string SLOT_CRAFT_HARDNESS         ;
    static const std::string SLOT_CRAFT_CRAFT_RESISTANCE ;
    static const std::string SLOT_CRAFT_COST             ;
    static const std::string SLOT_CRAFT_AVAILABILITY     ;
    static const std::string SLOT_CRAFT_TENACIOUSNESS    ;
    static const std::string SLOT_CRAFT_BREAKPOINT       ;
    static const std::string SLOT_CRAFT_SLOTS            ;
    static const std::string SLOT_CRAFT_MIN_DAMAGE       ;
    static const std::string SLOT_CRAFT_DEFENSE_BONUS    ;
    static const std::string SLOT_CRAFT_PRECISION_BONUS  ;
    static const std::string SLOT_CRAFT_DRILL_BONUS      ;
    static const std::string SLOT_CRAFT_IM_BONUS         ;
    static const std::string SLOT_CRAFT_CHANGES_DAMAGE_TYPE;
    static const std::string SLOT_CRAFT_OVERRIDDEN_DAMAGE_TYPE;
    static const std::string SLOT_CRAFT_STATS_GENERIC   ;
    static const std::string SLOT_CRAFT_STATS_RANGE     ;
    static const std::string SLOT_CRAFT_STATS_CADENCE   ;
    static const std::string SLOT_CRAFT_STATS_DAMAGE_TYPE;
    static const std::string SLOT_CRAFT_STATS_PRECISION_ATTRIBUTE;
    static const std::string SLOT_CRAFT_STATS_DAMAGE_ATTRIBUTE;
    static const std::string SLOT_CRAFT_STATS_DAMAGE_BONUS  ;
    static const std::string SLOT_CRAFT_STATS_SOAK_BONUS  ;
